...
The server binds to `0.0.0.0:8000`, which allows access from other devices (tablets, laptops, phones) on the same local network:
...
## 🛠️ Tech Stack
- **Backend:** FastAPI, Uvicorn, WebSockets, NumPy, Pandas
- **Frontend / GCS:** Vanilla HTML5, CSS3, JavaScript, Chart.js
- **Streaming:** Real-time bi-directional WebSockets (1 Hz telemetry stream)